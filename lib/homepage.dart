    ...
    return Material(
      child: Container(
        child: Center(
          child: ListView(
            children: <Widget>[
              // Top Icons to the pages
              Container(
                height: 430,
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("lib/images/starwars1.jpg"),
                      fit: BoxFit.fill),
                ),
                child: Column(
              ...
              makePopularWidget("Popular on WebApp"),
              makePopularWidget("Trending Now"),
              makeContinueWatching("Continue Watching "),
              bannerMovie(),
      ...
      movieList.add(new Container(
        ...
        decoration: new BoxDecoration(
          image: new DecorationImage(
              image:
                  new AssetImage("lib/images/" + counter.toString() + ".jpg"),
  ...
  List<Widget> makeContainers() {
    ...
    for (int i = 0; i < 6; i++) {
      ...
      movieList.add(Container(
        ...
        height: 200,
        child: Image(
          image: AssetImage("lib/images/" + counter.toString() + ".jpg"),
        ),
      ));
      if (counter == 12) {
        counter = 0;
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image:
                        AssetImage("lib/images/" + counter.toString() + ".jpg"),
                    fit: BoxFit.fitHeight,
                  ),
                ),
                child: Center(
